...
const WizardRankModule = (function() {
    ...
    const ranks = [
        ...
        { name: 'Gravity Magus', minAchievements: 925 },
        // New ranks: Life Magus, Death Magus
        { name: 'Life Magus', minAchievements: 950 },
        { name: 'Death Magus', minAchievements: 975 },
        { name: 'Light Magus', minAchievements: 1000 },
        { name: 'Dark Magus', minAchievements: 1025 },
        { name: 'White Magus', minAchievements: 1050 },
        { name: 'Black Magus', minAchievements: 1075 },
        { name: 'Silver Magus', minAchievements: 1100 },
        { name: 'Gold Magus', minAchievements: 1125 },
        { name: 'Arch Magus', minAchievements: 1150 },
        { name: 'Grand Magus', minAchievements: 1175 },
        { name: 'Void Magus', minAchievements: 1200 },
        { name: 'Archmage', minAchievements: 1225 },
        { name: 'Arcane Weaver', minAchievements: 1250 },
        // New ranks: Grand Weaver, True Weaver
        { name: 'Grand Weaver', minAchievements: 1275 },
        { name: 'True Weaver', minAchievements: 1300 },
        { name: 'Eldritch', minAchievements: 1325 },
        { name: 'Deity', minAchievements: 1350 },
        { name: 'Living Spell', minAchievements: 1375 },
        { name: 'True Arcana', minAchievements: 1400 },
        { name: 'Basic Cheater?', minAchievements: 1425 },
        { name: 'Completionist', minAchievements: 1450 }
    ];
