...
const WizardRankModule = (function() {
    ...
    const ranks = [
        ...
        { name: 'Enchantress', minAchievements: 400 },
        { name: 'Abjurer', minAchievements: 425 },
        { name: 'Illusionist', minAchievements: 450 },
        { name: 'Transmuter', minAchievements: 475 },
        { name: 'Alchemist', minAchievements: 500 },
        { name: 'Summoner', minAchievements: 525 },
        { name: 'Necromancer', minAchievements: 550 },
        { name: 'Evoker', minAchievements: 575 },
        { name: 'Magus', minAchievements: 600 },
        { name: 'Fire Magus', minAchievements: 625 },
        { name: 'Water Magus', minAchievements: 650 },
        { name: 'Air Magus', minAchievements: 675 },
        { name: 'Earth Magus', minAchievements: 700 },
        { name: 'Ice Magus', minAchievements: 725 },
        { name: 'Stone Magus', minAchievements: 750 },
        { name: 'Lightning Magus', minAchievements: 775 },
        // New rank: Plant Magus
        { name: 'Plant Magus', minAchievements: 800 },
        { name: 'Mind Magus', minAchievements: 825 },
        { name: 'Metal Magus', minAchievements: 850 },
        { name: 'Solar Magus', minAchievements: 875 },
        { name: 'Lunar Magus', minAchievements: 900 },
        { name: 'Astral Magus', minAchievements: 925 },
        { name: 'Gravity Magus', minAchievements: 950 },
        // New ranks: Life Magus, Death Magus
        { name: 'Life Magus', minAchievements: 975 },
        { name: 'Death Magus', minAchievements: 1000 },
        { name: 'Light Magus', minAchievements: 1025 },
        { name: 'Dark Magus', minAchievements: 1050 },
        { name: 'White Magus', minAchievements: 1075 },
        { name: 'Black Magus', minAchievements: 1100 },
        { name: 'Silver Magus', minAchievements: 1125 },
        { name: 'Gold Magus', minAchievements: 1150 },
        { name: 'Arch Magus', minAchievements: 1175 },
        { name: 'Grand Magus', minAchievements: 1200 },
        { name: 'Void Magus', minAchievements: 1225 },
        { name: 'Archmage', minAchievements: 1250 },
        { name: 'Arcane Weaver', minAchievements: 1275 },
        // New ranks: Grand Weaver, True Weaver
        { name: 'Grand Weaver', minAchievements: 1300 },
        { name: 'True Weaver', minAchievements: 1325 },
        { name: 'Eldritch', minAchievements: 1350 },
        { name: 'Deity', minAchievements: 1375 },
        { name: 'Living Spell', minAchievements: 1400 },
        { name: 'True Arcana', minAchievements: 1425 },
        { name: 'Basic Cheater?', minAchievements: 1450 },
        { name: 'Completionist', minAchievements: 1475 }
    ];
